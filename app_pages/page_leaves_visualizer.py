...
def page_leaves_visualizer_body():
    ...
    if st.checkbox("Difference between average and variability image"):
      ...
      st.write(
        f"* We notice the average and variability images did reveal clear a pattern to "
        f"differentiate the leaves, powdery mildew leaves clearly have white shades "
        f"throughout them."
        )

      st.image(avg_healthy, caption='Healthy Leaves - Average and Variability - Above')
      st.image(avg_powdery_mildew, caption='Powdery Mildew Leaves - Average and Variability - Above')
      st.write("---")
    ...
    if st.checkbox("Differences between average healthy and average powdery mildew leaves"):
          ...
          st.write(
            f"* We notice this study did show patterns where we could somewhat "
            f"differentiate one to another thanks to the white shades.")
